...
function Sidebar({ onCollapsedChange }: { onCollapsedChange?: (collapsed: boolean) => void }) {
  ...
  return (
    <div className="relative flex" style={{ width }}>
      {!isCollapsed && (
        <aside className="flex h-full flex-1 flex-col overflow-hidden rounded-xl border border-white/75 bg-stone-50 shadow-lg shadow-stone-400/10 dark:border-white/10 dark:bg-stone-900 dark:shadow-stone-950/20">
...
function TodayView({ isCollapsed }: { isCollapsed: boolean }) {
  return (
    <div className="flex h-full flex-col">
      {/* Top toolbar */}
      <div className="z-10 flex shrink-0 items-center gap-2 px-2 pt-0.5">
